...
/**
 *  @class WDAcceptCashManager
 *  @brief Cash Management
 */
@interface WDAcceptCashManager : NSObject
 ...
 */
-(void)updateCashier:(WDAcceptMerchantCashier *)cashier
 ...
 */
-(void)shifts:(NSString*)cashRegisterInternalId query:(WDAcceptShiftQuery* _Nonnull)query completion:(CashRegisterShiftCompletion)completion;
 ...
 */
-(void)updateCashRegister:(WDAcceptCashRegister*)cashRegister withSerialNumberFromTerminal:(WDAcceptTerminal*)terminal completion:(void (^)(BOOL success, WDAcceptCashRegister*updatedRegister, NSError *error))completion;
 ...
 */
-(void)getOperationsForShift:(NSString* _Nonnull)shiftId query:(WDAcceptQuery*)query belongingToCashRegister:(NSString* _Nonnull)cashRegisterId completion:(CashRegisterActivityCompletion)completion;
