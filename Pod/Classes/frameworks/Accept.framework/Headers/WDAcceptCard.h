...
/**
 *  @class WDAcceptCard
 *  @discussion Card Data supplied by terminal
 **/
...
@property (nullable, nonatomic,readonly)    NSString *pinData;
@property (nullable, nonatomic, readonly)   WDAcceptEncryptionParameters *pinEncryptionParams;

@end

/**
 *  @class WDAcceptCardEmvPassThroughDUKPT
 *  @discussion Card Data supplied by extension reading the ICC supporting decryption on the PaymentEngine side
 **/
@interface WDAcceptCardEmvPassThroughDUKPT : WDAcceptCardPassThroughDUKPT
...
-(nullable instancetype)initWithEMV:(NSString * _Nonnull )emvData
                     ...
                     dataEncryption:(WDAcceptEncryptionParameters * _Nullable)dataEncryption
                            pinData:(NSString * _Nullable)pinData
                      pinEncryption:(WDAcceptEncryptionParameters * _Nullable)pinEncryption
;
/**
 * Application label obtained from EMV data
 */
...
/**
 *  @class WDAcceptCardMagstripePassThroughDUKPT
 *  @discussion Card Data supplied by extension reading the Magstripe supporting decryption on the PaymentEngine side
 **/
@interface WDAcceptCardMagstripePassThroughDUKPT : WDAcceptCardPassThroughDUKPT

/**
 * @discussion Create Card data with the card details obtained from the Magstripe - PassThrough DUKPT
 * @param track2Data - Track 2 data
 * @param pan - masked PAN
 * @param posEntryMode 3 digit code see WDAcceptCardData POS Entry Mode
