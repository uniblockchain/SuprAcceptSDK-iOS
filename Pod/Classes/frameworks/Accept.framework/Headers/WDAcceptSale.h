...
#import "WDAcceptSaleItem.h"
#import <CoreLocation/CoreLocation.h>
#import "WDADataTypes.h"

@class WDAcceptTerminal, WDAcceptMerchant, WDAcceptMerchantUser,WDAcceptAddress,WDAcceptShop,WDAcceptReceiptData;
 ...
 *  @discussion Sale to be performed (WDAcceptSaleRequest) 
 *
 *              Sale already processed (WDAcceptSaleResponse)
 **/
@interface WDAcceptSale : WDAcceptObject <NSCoding>
/**
 */
 ...
 **/
-(WDAcceptTerminal* _Nullable)terminal;
...
/**
 */
-(NSArray<WDAcceptSaleSummaryItem*> *)taxSummary;
/**
 */
-(NSArray<WDAcceptSaleSummaryItem*> *)serviceChargeSummary;
/**
 */
-(NSArray<WDAcceptSaleSummaryItem*> *)tipSummary;
/**
 */
-(NSArray<WDAcceptSaleSummaryItem*> *)discountSummary;
/**
 */
-(NSArray<WDAcceptSaleSummaryItem*> *)couponSummary;
/**
 */
...
/**
 *  @class WDAcceptSaleRequest
 *  @brief The Sale to be processed
 *  @discussion Contains all necessary information to perform the Sale
 **/
@interface WDAcceptSaleRequest : WDAcceptSale
/**
 */
@property (nonatomic) AcceptSaleType type;
/**
 */
...
-(void)addCardPayment:(NSDecimalNumber * __nonnull)amount
                 terminal:(WDAcceptTerminal *)terminal;
 ...
 **/
-(void)removeItem:(WDAcceptSaleItem *)itemToRemove;
/**
 ...
 */
-(WDAcceptPaymentRequestCard *)requestedCardPayment;
/**
 * @brief Returns the Coupon payment if present on this Sale request
 */
-(WDAcceptPaymentRequestCoupon *)requestedCouponPayment;
/**
 * @brief Returns the Cash payment if present on this Sale request
 */
-(WDAcceptPaymentRequestCash *)requestedCashPayment;
/**
 * @brief Returns the Alipay payment if present on this Sale request
 */
-(WDAcceptPaymentRequestAlipay *)requestedAlipayPayment;
/**
...
/**
 *  @class WDAcceptSaleResponse
 *  @brief The processed Sale
 *  @discussion Contains all details about performed Sale
 **/
@interface WDAcceptSaleResponse : WDAcceptSale
/**
 */
@property (nonatomic,readonly) AcceptSaleType type;
/**
 ...
 */
@property (nonatomic, readonly) AcceptSaleState status;
/**
 ...
 */
@property (nonatomic, strong,readonly) WDAcceptMerchant *merchant;
/**
 * @brief Merchant user Set by backend after processing the Sale
 */
@property (nonatomic, strong,readonly) WDAcceptMerchantUser *user;
/**
 * @brief Merchant's shop user Set by backend after processing the Sale
 */
@property (nonatomic, strong,readonly) WDAcceptShop *shop;
/**
 ...
 */
-(AcceptPaymentState)mostOnerousStatus;
/**
 * @brief Returns all data necessary for creating the Receipt
 */
-(WDAcceptReceiptData *)getAcceptReceiptData;
 ...
 */
-(WDAcceptSaleRequest * _Nullable)saleReturn;
/**
 ...
 **/
NSString *const WDASaleTypeFromSaleType(AcceptSaleType saleType);

/**
 *  @discussion Get the  Sale operation from the internal sale operation
 *  @return Accept Sale operation
 **/
AcceptSaleType AcceptSaleTypeFromSaleType(NSString * type);
