...
SWIFT_MODULE_NAMESPACE_PUSH("AcceptUI")


@class NSCoder;
@class UIImage;

SWIFT_CLASS("_TtC8AcceptUI11WDTouchDraw")
...
@interface WDTouchDraw (SWIFT_EXTENSION(AcceptUI))
...
SWIFT_CLASS("_TtC8AcceptUI10WDUILoader")
