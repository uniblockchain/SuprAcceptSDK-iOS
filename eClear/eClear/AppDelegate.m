...
-(void)loginUser:(NSString *)username
    ...
    self.sdk = [AcceptSDK sharedInstance];
    [self.sdk setupWithEnvironment:AcceptEnvironmentFromUrl(backend)
                                            username:username
                                            password:password
                                          completion:^(WDAcceptMerchantUser * _Nullable currentUser, WDAcceptMerchantCashier * _Nullable cashier, NSError * _Nullable error) {
