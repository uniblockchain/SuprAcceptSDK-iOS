...
{
    MembersCompletion completion = ^(NSArray <WDAcceptMember *>*members, NSError *err)
    {
        returnedErr = err;
...
{
    void (^completion)(NSArray<WDAcceptProductPrice *> *, NSError *) = ^(NSArray<WDAcceptProductPrice *> * _Nullable productPrices, NSError * _Nullable error)
    {
...
{
    ProductStocksCompletion completion = ^(NSArray <WDAcceptProductStock *>*stocks, NSError *error)
    {
