...
@property (nonatomic, copy) void (^completion)(WDAcceptSaleResponse*, NSError*);
@end

@implementation PaymentHandler

- (instancetype)initWithCompletionBlock:(void (^)(WDAcceptSaleResponse*, NSError*))completionBlock {
    if ( (self = [super init]) ) {
...
- (void)completion:(WDAcceptSaleResponse * _Nullable)saleResponse saleResponseError:(NSError * _Nullable)saleResponseError {
...
- (void)confirm:(AcceptPaymentConfirmationType)confirmationType paymentConfirmationResult:(PaymentConfirmationResult _Nullable)paymentConfirmationResult {

    if (paymentConfirmationResult) {
        // Here the simplified use of Approving the Cardholder Signature is demonstrated
        paymentConfirmationResult(AcceptPaymentConfirmationResultApproved);
    }
...
- (void)setUp
{
    ...
    _paymentHandler = [[PaymentHandler alloc] initWithCompletionBlock:^(WDAcceptSaleResponse *transaction, NSError *error) {
